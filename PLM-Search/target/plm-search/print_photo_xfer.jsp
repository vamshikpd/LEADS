...
<div id="printlineupsmtdiv">
	<form id="htForm" method="post" action="GeneratePDFServlet">
		...
		<input id="showid" type="hidden" name="showid" value="<%=request.getParameter("showid")%>"/>
		<input id="psize" type="hidden" name="psize" value="<%=request.getParameter("psize")%>"/>
		<input id="firstName" type="hidden" name="firstName" value="<%=request.getParameter("firstName")%>"/>
		<input id="lastName" type="hidden" name="lastName" value="<%=request.getParameter("lastName")%>"/>
		<input id="pdfdisptype" type="hidden" name="pdfdisptype" value="photonist"/>
	</form>
</div>
</body>
</html>
