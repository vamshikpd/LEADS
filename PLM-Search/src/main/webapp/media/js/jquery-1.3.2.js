...
jQuery(document).ready(function() {
	jQuery.each(jQuery.browser, function(i, val) {
		...
		//alert("Yes this IE");
		$("select[name='searchlist']:enabled").wrap("<div class='wrapper'></div>");
	$("select[name='searchlist']:enabled").parent().append("&nbsp;");
	$("select[name='searchlist']:enabled").css("position", "relative")
			.css("z-index", "1")
			.css("width", "100%")
	.css("margin-right", "0px")
	.css("margin-bottom", "-14px");
	$("select[name='searchlist']:enabled")
        .mouseover(function() {
		$("select[name='searchlist']:enabled").css("position", "relative")
			.css("z-index", "1")
			.css("width", "100%")
		...
		//alert(autowidth + "...." + parentwidth);
		if(autowidth > parentwidth) {
			//alert("true");
		    $(this)
                .css("width", "auto")
...
*/
	/*
	document.write("<script type=\"text/javascript\" src=\"javascript/check_session.js\"></script>");
	var loginURL = top.top.document.getElementById("loginURL").value;
		$("a").click(function(){
			checkSession(loginURL);
		});

		$("form :input[type='image']:enabled" || "form :input[type='submit']:enabled").click(function(){
			checkSession(loginURL);
		});
