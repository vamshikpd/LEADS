...
SET HOME=D:\\Apps\\DataExtract
SET TEMPHOME=D:\\Endeca\\DataExtract
SET JAVA_HOME="D:\Java\jdk1.6.0_43"
SET ORACLE_HOME=D:\\Oracle\\product\\11.2.0\\client_1
SET ORACLE_SID=SOMSENFC.JPS.LOCAL
SET ENDECADIR=D:\\Endeca
...
sqlplus cpowner/p2ssw0rd@SOMSENFC.JPS.LOCAL @%BASEDIR%\scripts\loadEligibleParolees.sql >> %PROCESSLOGFILE% 2> %ERRORLOGFILE%

:executeGatherPC290SQL
echo [%date% %time%] Starting executeGatherPC290SQL >> %PROCESSLOGFILE%
sqlplus cpowner/p2ssw0rd@SOMSENFC.JPS.LOCAL @%BASEDIR%\scripts\PC290_BATCH.sql >> %PROCESSLOGFILE% 2> %ERRORLOGFILE%
