...
<html>
	<head>
		...
		<title>PC290 Discharge Search</title>
				...
				<div id="Container">
					...
					<div id="Middle">
						<div id="MainContainer">
							<form name="dischargeNotificationSearch" action="pc290_discharge.jsp">
								<div class="caseandreasonform">
									<div class="formbox">
										<div class="formboxtitle">PC290 Discharge Search</div>
...
%>
											...
											<div class="gobutton"><input type="button" id="go" onclick="dischargeNotifySearch('dischargeNotificationSearch','<%=userName%>','<%=ip_address%>')" name="submit" value="Go" /></div>
										</div>
									</div>
								</div>
							</form>
...
function dischargeNotifySearch(formName,userName,ipAddress){
	...
	if(isAjaxEnabled==true){
		...
		url = url + "&doAudit=true&county="+countyValue+"&city="+cityValue+"&userName="+userName+"&ipAddress="+ipAddress+"&qry_type=D";
	}
	top.location=url;
}
